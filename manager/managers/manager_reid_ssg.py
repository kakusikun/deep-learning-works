...
from manager.utility import TripletLoss, ClusterAssignment
...
class Model(nn.Module):
    def __init__(self, cfg):
        ...
        #  self.assignment = ClusterAssignment(cluster_number=cfg.INPUT.TRAIN_BS // cfg.REID.SIZE_PERSON, embedding_dimension=1536)
